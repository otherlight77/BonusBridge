const CACHE='bonusbridge-beta-v5.0';
const SHELL=[
  ...
  './data/insurers.json','./data/insurer-sources.json','./data/documents.json','./data/provinces-canada.json','./data/regions-france.json','./data/scraping-status.json','./data/source-history.json'
];
